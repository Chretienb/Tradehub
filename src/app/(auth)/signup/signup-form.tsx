      ...
      <div className="flex flex-col px-4 py-6 sm:px-8 sm:py-8 lg:overflow-y-auto lg:px-12 lg:py-10 xl:px-20">
        ...
        <div className="flex flex-1 items-center py-10">
          {role === "customer" && step === "code" ? (
            <form onSubmit={handleVerifyCode} className="mx-auto flex w-full max-w-sm flex-col gap-6">
              <div>
                <button
                  type="button"
                ...
                <h1 className="mt-3 text-2xl font-semibold tracking-tight">Entrez le code</h1>
              ...
              <Button type="submit" className="w-full" size="lg" disabled={submitting}>
                {submitting ? "Vérification…" : "Vérifier et créer le compte"}
              </Button>
            ...
            <form
              onSubmit={role === "vendor" ? handleVendorSignup : handleSendCode}
